        ...
        <div className="productDetailExp" class="grid grid-cols-2 gap-[3rem]">
          <div class="flex flex-col gap-[1rem]">
            ...
            <p>
              ...
              <br />※ TABLE FOR TWOとは
              <br />
              先進国の人々と開発途上国の子どもたちが食事を分かち合うというコンセプトで活動する特定非営利活動法人。
              <br />
              世界では、約10億人が飢餓や栄養失調で苦しむ一方、約20億人が食に起因する生活習慣病を抱えています。
              <br />
              この食の不均衡を解消し、開発途上国と先進国双方の人々の健康を同時に改善することをミッションとしています。
            </p>
          </div>
          <div class="flex flex-col gap-[1rem]">
